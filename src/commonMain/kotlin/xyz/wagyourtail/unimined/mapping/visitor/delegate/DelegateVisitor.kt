...
open class Delegator(delegator: Delegator? = null) {
    ...
    open fun visitJavadoc(delegate: JavadocParentNode<*>, value: String, namespaces: Set<Namespace>): JavadocVisitor? {
        return delegate.visitJavadoc(value, namespaces)?.let { DelegateJavadocVisitor(it, delegator) }
    }
    ...
    open fun visitPackageJavadoc(delegate: PackageVisitor, value: String, namespaces: Set<Namespace>): JavadocVisitor? {
        return visitJavadoc(delegate, value, namespaces)
    }


    open fun visitClassJavadoc(delegate: ClassVisitor, value: String, namespaces: Set<Namespace>): JavadocVisitor? {
        return visitJavadoc(delegate, value, namespaces)
    }

    open fun visitMethodJavadoc(delegate: MethodVisitor,value: String, namespaces: Set<Namespace>): JavadocVisitor? {
        return visitJavadoc(delegate, value, namespaces)
    }

    open fun visitWildcardJavadoc(delegate: WildcardVisitor, value: String, namespaces: Set<Namespace>): JavadocVisitor? {
        return visitJavadoc(delegate, value, namespaces)
    }

    open fun visitFieldJavadoc(delegate: FieldVisitor, value: String, namespaces: Set<Namespace>): JavadocVisitor? {
        return visitJavadoc(delegate, value, namespaces)
    }

    open fun visitParameterJavadoc(delegate: ParameterVisitor, value: String, namespaces: Set<Namespace>): JavadocVisitor? {
        return visitJavadoc(delegate, value, namespaces)
    }

    open fun visitLocalVariableJavadoc(delegate: LocalVariableVisitor, value: String, namespaces: Set<Namespace>): JavadocVisitor? {
        return visitJavadoc(delegate, value, namespaces)
    }
...
open class DelegatePackageVisitor(delegate: PackageVisitor, delegator: Delegator) : DelegateBaseVisitor<PackageVisitor>(delegate, delegator), PackageVisitor by delegate {
    ...
    override fun visitJavadoc(value: String, namespaces: Set<Namespace>): JavadocVisitor? {
        return delegator.visitPackageJavadoc(delegate, value, namespaces)
    }
...
open class DelegateClassVisitor(delegate: ClassVisitor, delegator: Delegator) : DelegateBaseVisitor<ClassVisitor>(delegate, delegator), ClassVisitor {
    ...
    override fun visitJavadoc(value: String, namespaces: Set<Namespace>): JavadocVisitor? {
        return delegator.visitClassJavadoc(delegate, value, namespaces)
    }
...
open class DelegateMethodVisitor(delegate: MethodVisitor, delegator: Delegator) : DelegateBaseVisitor<MethodVisitor>(delegate, delegator), MethodVisitor {
    ...
    override fun visitJavadoc(value: String, namespaces: Set<Namespace>): JavadocVisitor? {
        return delegator.visitMethodJavadoc(delegate, value, namespaces)
    }
...
open class DelegateFieldVisitor(delegate: FieldVisitor, delegator: Delegator) : DelegateBaseVisitor<FieldVisitor>(delegate, delegator), FieldVisitor {
    ...
    override fun visitJavadoc(value: String, namespaces: Set<Namespace>): JavadocVisitor? {
        return delegator.visitFieldJavadoc(delegate, value, namespaces)
    }
...
open class DelegateWildcardVisitor(delegate: WildcardVisitor, delegator: Delegator) : DelegateBaseVisitor<WildcardVisitor>(delegate, delegator), WildcardVisitor {
    ...
    override fun visitJavadoc(value: String, namespaces: Set<Namespace>): JavadocVisitor? {
        return delegator.visitWildcardJavadoc(delegate, value, namespaces)
    }
...
open class DelegateParameterVisitor(delegate: ParameterVisitor, delegator: Delegator) : DelegateBaseVisitor<ParameterVisitor>(delegate, delegator), ParameterVisitor {
    ...
    override fun visitJavadoc(value: String, namespaces: Set<Namespace>): JavadocVisitor? {
        return delegator.visitParameterJavadoc(delegate, value, namespaces)
    }
...
open class DelegateLocalVariableVisitor(delegate: LocalVariableVisitor, delegator: Delegator) : DelegateBaseVisitor<LocalVariableVisitor>(delegate, delegator), LocalVariableVisitor {
    ...
    override fun visitJavadoc(value: String, namespaces: Set<Namespace>): JavadocVisitor? {
        return delegator.visitLocalVariableJavadoc(delegate, value, namespaces)
    }
