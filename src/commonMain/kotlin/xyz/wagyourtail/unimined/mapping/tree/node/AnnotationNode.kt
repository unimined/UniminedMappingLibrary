...
class AnnotationNode<U: MemberVisitor<U>>(parent: MemberNode<U, *>, val type: AnnotationType, val baseNs: Namespace, val Annotation: Annotation) : BaseNode<AnnotationVisitor, U>(parent), AnnotationVisitor {
