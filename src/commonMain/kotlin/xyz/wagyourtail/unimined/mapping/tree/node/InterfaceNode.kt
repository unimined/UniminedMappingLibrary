...
class InterfaceNode(parent: BaseNode<ClassVisitor, *>?, val type: InterfacesType, val name: ClassTypeSignature, val baseNs: Namespace): BaseNode<InterfaceVisitor, ClassVisitor>(parent), InterfaceVisitor {
